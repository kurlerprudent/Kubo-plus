...
// Assuming you are using a UI library like shadcn/ui.
// These are simplified versions for completeness.
...
// --- Icon Placeholders ---
// Replace these with your actual SVG icon components.
...
const MedicalIcon = ({ className }: { className?: string }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h6m-3-3v3" /></svg>
);
const RadiologyIcon = ({ className }: { className?: string }) => (
                                            ...
                                            {item.id === "ug-meeting" && (
                                                <div className="mt-auto">
                                                    ...
                                                    <div className="flex flex-wrap gap-2">
                                                        {item.attendees?.map((person: string, idx: number) => (
                                                            <span
                                                                key={idx}
